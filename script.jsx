...
if (!dados || typeof dados !== 'object' || !dados.componentes || !isArray(dados.componentes)) {
    ...
    var grupoPrincipal = abaLegenda.add("panel", undefined, "Informações Principais @@@33330000");
...
botaoAtualizarGit.onClick = function() {
    try {
        ...
        scriptFile.write("    echo No updates available > update_status.tmp\n");
        ...
        if (scriptFile.execute()) {
            ...
            if (statusFile.exists) {
                ...
                if (status.indexOf("No updates available") !== -1) {
                    alert("Não há atualizações disponíveis. O script já está na versão mais recente.");
