...
function executarScript() {
    ...
    // Lista de combinações com barra de rolagem
    var grupoCombinacoes = abaCombinacoes.add("group");
    grupoCombinacoes.orientation = "row";
    grupoCombinacoes.alignChildren = ["fill", "fill"];
    var listaCombinacoes = grupoCombinacoes.add("listbox", undefined, [], {multiselect: false});
    listaCombinacoes.preferredSize.width = 500;
    listaCombinacoes.preferredSize.height = 300;
