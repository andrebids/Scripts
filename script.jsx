...
if (!dados || typeof dados !== 'object' || !dados.componentes || !isArray(dados.componentes)) {
    ...
    var grupoPrincipal = abaLegenda.add("panel", undefined, "Informações Principais @@@3333000099999999999111117777");
    ...
    try {
        ...
        if (scriptFile.execute()) {
            ...
            if (statusFile.exists) {
                ...
                alert("Não foi possível determinar o status da atualização.");
            }
